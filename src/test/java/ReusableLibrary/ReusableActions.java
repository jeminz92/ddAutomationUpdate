...
public class ReusableActions {
    ...
    public static void scrollIntoView(WebDriver driver, String xpath, int scrollIndex, String elementName) {
        WebDriverWait wait = new WebDriverWait(driver, Timeout);
    ...
    public static void navigateTo(WebDriver driver, String name) {
